...
void renderCornellboxProjectiveLight(float scale, const char* filename) {
    Image img(400, 400);
    World world;
    SimpleGroup* scene = new SimpleGroup();
    world.scene = scene;
    ...
    //projective light
    world.light.push_back(new ProjectiveLight(Point(288*scale,379.99f*scale,129.5f*scale),RGBColor::rep(60000.0f*scale*scale)));
...
void a_lighting() {
	...
	renderCornellboxProjectiveLight(0.01f, "a4-5.png");
}
